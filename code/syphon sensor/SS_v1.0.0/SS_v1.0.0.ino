...
// define sensor pin for contact sensor
#define contactPin A10
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("*** Executing SS_v1.0.0.ino ***"));
...
void loop() {
  ...
  Serial.print("Contact state: "); Serial.println(state);
  char stateBuff[2];
  itoa(state, stateBuff, 10);
  ...
  MQTT_publish_checkSuccess(feed_contact, stateBuff);
